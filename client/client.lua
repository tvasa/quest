...
table.insert(menuItems, {
    ...
    onSelect = function()
        ...
        TriggerServerEvent('InteractSound_SV:PlayWithinDistance', 0.5, 'quest1', 1.0)
    end
    })
...
RegisterNetEvent("quest:accepted")
AddEventHandler("quest:accepted", function()
    print("Úkol byl přijat! Jděte nasbírat 5 mrkví.")
    end)
    
RegisterNetEvent("quest:reward")
AddEventHandler("quest:reward", function()
    print("Úkol dokončen! Byli jste odměněni.")
    end)
    
RegisterNetEvent("quest:fail")
AddEventHandler("quest:fail", function()
    print("Úkol selhal! Nemáte dostatek mrkví.")
    end)    